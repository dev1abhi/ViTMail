      ...
      case 'events':
        filteredList = emails
            .where((email) =>
                ...
                email.subject.toLowerCase().contains('gravitas'))
            .toList();
        break;
      case 'misc':
        filteredList = emails
            .where((email) =>
                ...
                email.subject.toLowerCase().contains('notes'))
            .toList();
        break;
    }
